...
2. A pop-up will appear to configure the Desktop Agent version. Do the following in the pop up:
    ...
    - In the pop-up window select the version of the Desktop Agent installed on your machine from the dropdown. During the exercise we would use version **2.0.30**; so please select it from the dropdown.
    - Choose **Confirm**.
