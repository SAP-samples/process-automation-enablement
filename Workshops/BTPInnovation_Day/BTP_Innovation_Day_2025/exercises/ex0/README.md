...
Pre-requisites <br>
1.[How to Login](README.md#details-of-tenant-and-login)<br>
2.[Save as New Project](README.md#project-creation-by-save-as-new-project)
...
<br>![](images/SaveAsNewProject_User_name.png) <br>
...
<br>![](images/DT_Prompt.png)
3. Items Data type gets generated as below
   <br>![](images/Items_DT.png)
...
<br>![](images/PRSubForm.png)

3. Once the form is generated, enter the Subject:"PR Submission Form" and map the Recipients users to "Started By" in the process Metadata  <br>![](images/Fill_Form_Mandatory_Params.png) 
4. Click on Save.<br>
<br>![](images/Save.png)
5. Click anywhere on the canvas and then click on ![](images/Arrow.png) to open side process panel, select Variables and click on Configure for Process Input Variables.
   <br>![](images/CustomVar.png)<br>
...
<br>![](images/Configure_Process_Inputs.png) 
7. Click on Add a Trigger, select API Trigger, give it a name "Purchase Order Process Trigger" and click on Create.<br>
<br>![](images/API_Trigger.png)
<br>![](images/Create_API_Trigger.png)
   
8.  Click anywhere on the canvas and then click on ![](images/Arrow.png) to open side process panel, select Variables, configure process custom variables "Totalprice" (of number type) , "ApprovalStatus" (of string type) click on apply and Save the process.<br>
<br>![](images/CustomVar.png)<br>
<br>![](images/CustomVariables_Configure.png)
...
<br>![](images/MapInput_Variables.png)
...
<br>![](images/RulePrompt.png)<br>
<br>![](images/DecisionTable.png)
